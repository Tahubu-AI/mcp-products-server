...
using McpProductsClient.Components;
...
var otelExporterEndpoint = builder.Configuration.GetValue<string>("OTEL_EXPORTER_OTLP_ENDPOINT");
var otelExporterHeaders = builder.Configuration.GetValue<string>("OTEL_EXPORTER_OTLP_HEADERS");
